# Del 3 - Prøv de andre ADC.WIDTH_ værdier 9BIT 10BIT og 11BIT og kør skriv kommentarer i koden hvor der foklares hvad de gør.
# se documentation under sektionen ADC og undersektionen ADC.width(width)
...
def pot_np(pot_input): # Definer den funktion som skal benyttes
    for i in range(n): # Få en relativ OK-værdi til 
        ...
        sleep(pot.read()/15000) # Hvor lang tid der går mellem hver LED
